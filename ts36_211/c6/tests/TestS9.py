import unittest
from ...core.Enums import SPECIAL_SUBFRAME_PATTERNS, CP_TYPE, DELTA_F, DUPLEX_MODE, SUBFRAME_ASSIGNMENT, BW, RE_TYPE, PHICH_DURATION, PHICH_RESOURCE
...
class TestS9(unittest.TestCase):
    ...
    def test_phich(self):
        ...
        c.phichDuration = PHICH_DURATION.NORMAL
        c.phichResource = PHICH_RESOURCE.HALF
        frame = Frame(c)
        l = 0
